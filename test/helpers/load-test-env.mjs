...
if (process.env.PROJECT_MANAGER_TELEGRAM_BOT_KEY) {
  process.env.CLAWCHEF_VAR_PROJECT_MANAGER_TELEGRAM_BOT_KEY = process.env.PROJECT_MANAGER_TELEGRAM_BOT_KEY;
}
if (process.env.KNOWLEDGE_MANAGER_TELEGRAM_BOT_KEY) {
  process.env.CLAWCHEF_VAR_KNOWLEDGE_MANAGER_TELEGRAM_BOT_KEY = process.env.KNOWLEDGE_MANAGER_TELEGRAM_BOT_KEY;
}
