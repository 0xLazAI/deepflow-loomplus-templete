...
This guideline is for deepflow developers and defines how `coordinator`, `demo-worker`, and the shared `docs-manager` skill work together.
...
- `coordinator` writes handoff docs and consumes receipts.
- `demo-worker` consumes handoff docs and writes receipts.
